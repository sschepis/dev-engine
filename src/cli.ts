...
import { DevEngine, DevEngineOptions } from './core/DevEngine.js';
import { OpenClawAdapter, OpenClawAdapterOptions } from './adapters/OpenClawAdapter.js';
import { ConsoleEventLogger } from './core/EventEmitter.js';
...
async function main(): Promise<void> {
  ...
  // Configure adapter
  const adapterOptions: OpenClawAdapterOptions = {
    model: args.model,
    logPrefix: 'DevEngine'
  };
  ...
  // Configure engine
  const engineOptions: DevEngineOptions = {
